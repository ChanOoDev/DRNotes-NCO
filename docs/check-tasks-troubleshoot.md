...
| Repo | Owner | Purpose |
|------|-------|---------|
| `ChanOoDev/DRNotes-NCO` | Developer | Source code |
| `SiThuTun-mdy/Dr-Note` | PM | Issue tracker |

Issues are **assigned to the developer** (`ChanOoDev`) in the **PM's repo** (`SiThuTun-mdy/Dr-Note`).
...
| Command | Description |
|---------|-------------|
| `gh issue list --repo ChanOoDev/DRNotes-NCO --assignee @me` | Check code repo (usually empty) |
